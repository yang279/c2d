export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OctoAI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OctoAI.",
  ...
  "provider.connect.opencodeZen.line1":
    "OctoAI Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OctoAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OctoAI.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OctoAI se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de OctoAI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OctoAI",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OctoAI no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "OctoAI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor OctoAI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para OctoAI",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve OctoAI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OctoAI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OctoAI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OctoAI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OctoAI.",
  ...
  "file.delete.title": "Eliminar archivo",
  "file.delete.confirm": '¿Eliminar archivo "{{name}}"?',
  "file.delete.plural.confirm": "¿Eliminar {{count}} archivos seleccionados?",
  "file.delete.button": "Eliminar",
