export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OctoAI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OctoAI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "OctoAI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OctoAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OctoAI.",
  ...
  "provider.custom.field.apiKey.editDescription": "Optional. Leave empty to keep the existing API key.",
  ...
  "provider.custom.models.modalities.label": "Modalities (optional)",
  "provider.custom.models.modalities.key.label": "Modality key",
  "provider.custom.models.modalities.key.placeholder": "input",
  "provider.custom.models.modalities.value.label": "Modality value",
  "provider.custom.models.modalities.value.placeholder": '["text", "image"]',
  "provider.custom.models.modalities.remove": "Remove modality",
  "provider.custom.models.modalities.add": "Add modality",
  ...
  "provider.custom.error.modalities.key": "Use input or output",
  "provider.custom.error.modalities.array": "Enter a valid JSON array",
  "provider.custom.error.modalities.empty": "Array cannot be empty",
  "provider.custom.error.modalities.value": "Use text, audio, image, video, or pdf",
  "provider.custom.error.modalities.required": "Include both input and output",
  ...
  "prompt.hint.newSession": "Type here to start a conversation",
  ...
  "dialog.server.description": "Switch which OctoAI server this app connects to.",
  ...
  "toast.update.description": "A new version of OctoAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OctoAI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OctoAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OctoAI includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OctoAI Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OctoAI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OctoAI",
  ...
  "settings.general.row.appearance.description": "Customise how OctoAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OctoAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OctoAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OctoAI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OctoAI.",
  ...
  "settings.defaultModel.title": "Default Model",
  "settings.defaultModel.description": "Set the default LLM model used across Chat, Insight, and Studio pages.",
  "settings.defaultModel.section.current": "Current Default",
  "settings.defaultModel.change": "Change",
  "settings.defaultModel.select": "Select",
  "settings.defaultModel.clear": "Clear",
  "settings.defaultModel.notSet": "Not configured — will use the first available model",
  "settings.defaultModel.hint": "When not set, each page will automatically select an available model. You can still manually switch models in the Chat page.",
  "settings.defaultModel.cleared": "Default model cleared",
  "settings.defaultModel.select.title": "Select Default Model",
  ...
  "file.delete.confirm": 'Delete file "{{name}}"?',
  "file.delete.plural.confirm": "Delete {{count}} selected files?",
  "file.delete.button": "Delete",
  ...
  "designFiles.timeToday": "Today",
  "designFiles.timeYesterday": "Yesterday",
