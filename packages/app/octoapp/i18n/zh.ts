...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 OctoAgent Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "OctoAgent 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 OctoAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "OctoAgent Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 OctoAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 OctoAgent 中使用 {{provider}} 模型。",
  ...
  "provider.custom.field.apiKey.editDescription": "可选。留空将保留现有 API 密钥。",
  ...
  "provider.custom.models.modalities.label": "Modalities 配置（可选）",
  "provider.custom.models.modalities.key.label": "Modalities Key",
  "provider.custom.models.modalities.key.placeholder": "input",
  "provider.custom.models.modalities.value.label": "Modalities Value",
  "provider.custom.models.modalities.value.placeholder": '["text", "image"]',
  "provider.custom.models.modalities.remove": "移除 Modalities 配置",
  "provider.custom.models.modalities.add": "添加 Modalities 配置",
  ...
  "provider.custom.error.modalities.key": "仅支持 input 或 output",
  "provider.custom.error.modalities.array": "请输入有效的 JSON 数组",
  "provider.custom.error.modalities.empty": "数组不能为空",
  "provider.custom.error.modalities.value": "仅支持 text、audio、image、video 或 pdf",
  "provider.custom.error.modalities.required": "必须同时配置 input 和 output",
  ...
  "dialog.server.description": "切换此应用连接的 OctoAgent 服务器。",
  ...
  "toast.update.description": "OctoAgent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OctoAgent 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: OctoAgent 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "OctoAgent 提供免费模型，你可以立即开始使用。",
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，如 Claude、GPT、Gemini 等。",
  "sidebar.project.recentSessions": "最近会话",
  "sidebar.project.viewAllSessions": "查看全部会话",
  "sidebar.project.clearNotifications": "清除通知",

  "app.name.desktop": "OctoAgent Desktop",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 OctoAgent 服务器。",
  ...
  "settings.general.row.language.description": "更改 OctoAgent 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 OctoAgent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OctoAgent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OctoAgent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OctoAgent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OctoAgent。",
  ...
  "designFiles.timeToday": "今天",
  "designFiles.timeYesterday": "昨天",
