export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OctoAI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OctoAI.",
  ...
  "provider.connect.opencodeZen.line1":
    "OctoAI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OctoAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OctoAI.",
  ...
  "dialog.server.description": "Skift hvilken OctoAI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OctoAI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OctoAI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OctoAI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OctoAI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OctoAI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OctoAI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OctoAI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OctoAI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OctoAI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OctoAI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OctoAI.",
  ...
  "file.delete.title": "Slet fil",
  "file.delete.confirm": 'Slet filen "{{name}}"?',
  "file.delete.plural.confirm": "Slet {{count}} valgte filer?",
  "file.delete.button": "Slet",
