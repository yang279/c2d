...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "OctoAI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "OctoAI Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 OctoAI 中使用 {{provider}} 模型。",
  ...
  "provider.custom.field.apiKey.editDescription": "選填。留空將保留現有 API 金鑰。",
  ...
  "provider.custom.models.modalities.label": "Modalities 設定（選填）",
  ...
  "provider.custom.models.modalities.remove": "移除 Modalities 設定",
  "provider.custom.models.modalities.add": "新增 Modalities 設定",
  ...
  "provider.custom.error.modalities.key": "僅支援 input 或 output",
  "provider.custom.error.modalities.array": "請輸入有效的 JSON 陣列",
  "provider.custom.error.modalities.empty": "陣列不能為空",
  "provider.custom.error.modalities.value": "僅支援 text、audio、image、video 或 pdf",
  "provider.custom.error.modalities.required": "必須同時設定 input 和 output",
  ...
  "dialog.server.description": "切換此應用程式連線的 OctoAI 伺服器。",
  ...
  "toast.update.description": "OctoAI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OctoAI 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: OctoAI 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "OctoAI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 OctoAI 伺服器。",
  ...
  "settings.general.row.language.description": "變更 OctoAI 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 OctoAI 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 OctoAI 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OctoAI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OctoAI 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OctoAI。",
