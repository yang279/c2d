export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OctoAI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OctoAI.",
  ...
  "provider.connect.opencodeZen.line1":
    "OctoAI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OctoAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OctoAI.",
  ...
  "dialog.server.description": "Changez le serveur OctoAI auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OctoAI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OctoAI",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OctoAI ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "OctoAI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur OctoAI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OctoAI",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OctoAI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OctoAI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OctoAI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OctoAI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OctoAI.",
  ...
  "file.delete.title": "Supprimer le fichier",
  "file.delete.confirm": 'Supprimer le fichier "{{name}}" ?',
  "file.delete.plural.confirm": "Supprimer {{count}} fichiers sélectionnés ?",
  "file.delete.button": "Supprimer",
