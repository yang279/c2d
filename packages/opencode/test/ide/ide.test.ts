...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OCTO_CALLER", () => {
    process.env["OCTO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OCTO_CALLER", () => {
    process.env["OCTO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OCTO_CALLER", () => {
    process.env["OCTO_CALLER"] = "unknown"
