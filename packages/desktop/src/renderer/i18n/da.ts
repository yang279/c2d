export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Octo AI er blevet downloadet. Vil du installere den og genstarte?",
