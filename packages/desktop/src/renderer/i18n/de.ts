export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Octo AI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
