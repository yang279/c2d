export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Octo AI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
