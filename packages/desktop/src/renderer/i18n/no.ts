export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Octo AI er lastet ned. Vil du installere den og starte på nytt?",
