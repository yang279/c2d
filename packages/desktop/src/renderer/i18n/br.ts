export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Octo AI foi baixada. Você gostaria de instalá-la e reiniciar?",
