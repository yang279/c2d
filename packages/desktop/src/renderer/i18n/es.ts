export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Octo AI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Octo AI. ¿Quieres instalarla y reiniciar?",
